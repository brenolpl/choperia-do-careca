...
public class MicroterminalService {
    ...
    private void processKey(int key, DataOutputStream dos) throws IOException {
        ...
        switch (key) {
            ...
            case -35:  // Tecla ENTER
                ...
                recuperarProdutoPorCodigoBarras(codigoCartaoCliente, dos);
                break;
    ...
    private void recuperarProdutoPorCodigoBarras(String codigoCartaoCliente, DataOutputStream dos) throws IOException {
        ...
        try {
            ...
            con.disconnect();
            dos.flush();
            dos.writeUTF("Total da conta do cliente: R$ " + content.toString());
        } catch (Exception e) {
            dos.flush();
